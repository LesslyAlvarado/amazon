    ...
    <section>
        ...
        <div class="row container ">
            ...
            <div class="col-12 text-white pt-5 text-center">
                ...
                <h1 class="pt-5"><a href="formulario_producto">Agregar producto</a></h1>
                <h1 class="py-5 pixelify-sans">Listado productos</h1>
                    ...
                    <table class="table table-dark table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img class="w-50" src="/imagenes_productos/{{ $producto['imagen'] }}"></td>
                                <td>
                                    <a href="formulario_producto/{{$producto['id']}}">Editar</a>
                                    <a href="eliminar_producto/{{$producto['id']}}">Eliminar</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
