...
<body class="fira-sans-condensed-regular" style="background-color: #2C1A4D;">
    ...
    <section class="container" style="margin-top: 100px;">
        ...
        <div class="row">
            ...
            <div class="mb-2">
                <h2 class="m-0" style="color: #C5B3E6;">Compras</h2>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="container row d-flex col-lg-4 col-md-4 col-12 text-center">

                        <h3 id="nombre" class="mt-3" style="color: #8C68CD;"></h1>

                        <h3 id="precio" style="color: gray;"></h5>

                        <h3 id="fecha" style="color: #E2D9F3;"></h3>

                                <a href="historialCompras"><button class="btn" type="submit"
                                        style="background-color: transparent; color: #E0CFFC; border: 2px solid;">Cerrar</button></a>
                    </div>
                    <div class="col-2"></div>
    ...
    <script>
        ...
        function generarTabla(data) {
            ...
            data.Compras.forEach(item => { //
                ...
                fila += "<td><a href='detalleCompra'><button class='btn' type='submit' style='background-color: #6F42C1; color: #E0CFFC;'>Ver Detalle</button><a/></td>"; //
                fila += "<tr>";
            ...
            fetch(urlApi, {
                ...
                .then(data => {
                    ...
                    data.Compras.forEach(item => { //
                        ...
                        fila += "<td>" + item.fecha + "</td>";
                        fila += "<td>$" + item.precio + "</td>";
                        fila += "<td><button class='btn' type='submit' style='background-color: #6F42C1; color: #E0CFFC;' onclick='mostrarCompra(" + item.id + ")'>Ver Detalle</button></td>"; //
                        fila += "<tr>";
                        tabla.innerHTML += fila;
                    });
                });
